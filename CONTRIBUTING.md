# Contributing to FSharp.EventHorizon
...
your Operating System, as well as your `dotnet` (or `mono` \ .Net Framework), F# and FSharp.EventHorizon versions. Please provide steps to
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/FSharp.EventHorizon
   # Navigate to the newly cloned directory
   cd FSharp.EventHorizon
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/Ionide/FSharp.EventHorizon
   ```
